...
- [Code Files & Explanation](#code-files--explanation) | (`to view the code,click the link (code files)`)
...
│   ├── serializers.py             # DRF serializers (PatientSerializer, etc.) |schemas validation
│   |
