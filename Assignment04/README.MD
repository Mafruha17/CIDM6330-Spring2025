...
4. **`mainapp/views/`**  
   - **`patient_views.py`, `device_views.py`, `provider_views.py`**: Define your Django REST Framework ViewSets (either `ModelViewSet` or `ViewSet`) for CRUD and custom assignment actions.
