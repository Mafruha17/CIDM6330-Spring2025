...
@router.post("/", response_model=PatientSchema,summary="Create a Patient")
...
@router.get("/{patient_id}", response_model=PatientSchema,summary="Get a Patient")
...
@router.post("/{patient_id}/providers/{provider_id}")
